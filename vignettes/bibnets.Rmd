...
`backbone()` applies the disparity filter proposed by Serrano, Boguñá, and
Vespignani:
...
The implementation and terminology follow standard bibliometric network
construction work, especially sparse two-mode network multiplication,
co-citation, normalization, fractional counting, and backbone filtering:
