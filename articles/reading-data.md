...
entry point, the generic-CSV path, building networks directly from
custom columns and separators (no reader needed), the
...
## 11. Custom CSV — map columns by name
...
## 12. Custom columns and separators (no reader needed)
...
## 15. Combining data from multiple sources
...
## 16. Inspecting and sanity-checking
